// Sina Finance K-line data decryption function
// Extracted from akshare/stock/cons.py hk_js_decode
// Used by bond_zh_hs_cov_daily to decode obfuscated Sina historical data
// This function is executed via Node.js vm module (runJsFunction)
...
function d(t) {
  var e,
    ...
    h = ~(3 << 30),
    f = 1 << 30,
    m = [0, 3, 5, 6, 9, 10, 12, 15, 17, 18, 20, 23, 24, 27, 29, 30],
    p = Math,
    g = () => {
      var l, u;
      for (l = 0; 64 > l; l++)
        (d[l] = p.pow(2, l)),
          26 > l &&
            ((c[l] = v(l + 65)), (c[l + 26] = v(l + 97)), 10 > l && (c[l + 52] = v(l + 48)));
      for (c.push("+", "/"), c = c.join(""), i = t.split(""), n = i.length, l = 0; n > l; l++)
        i[l] = c.indexOf(i[l]);
      return (
        (r = {}),
        (e = o = 0),
    ...
    T = (t) => {
      ...
      return t
        ? 0 > t
          ? ((e = T(-t)), [-e[0], -e[1]])
          : ((e = t % 3), (i = (t - e) / 3), (n = [i, i]), e && n[e - 1]++, n)
        : [0, 0];
    },
    P = (t, e, i) => {
      var n, r, a;
      for (
        r = "number" == typeof e ? T(e) : e, a = T(i), n = [a[0] - r[0], a[1] - r[1]], r = 1;
        n[0] < n[1];
      )
        (r *= 5), n[1]--;
      for (; n[1] < n[0]; ) (r *= 2), n[0]--;
    ...
    C = () => {
      ...
      for (
        ...
        (o = {
          ...
          y() &&
            ((a = w([3])[0]),
            0 == a ? (o.d = w([6])[0]) : 1 == a ? ((r.d = w([18])[0]), (o.d = 0)) : (o.d = a)),
          (l = {
            date: S(o.d),
          }),
          y() && (r.ld += N()),
    ...
    _ = () => {
      ...
      for (
        r.m = p.pow(10, r.pp),
          s >= 1 ? ((a = w([3, 3])), (r.c = a[0]), (a = a[1])) : ((a = 5), (r.c = 2)),
          r.pc = w([6 * a])[0],
          d.pc = r.pc / r.m,
          r.cp = r.pc,
          r.da = 0,
        ...
        (r.sv += o.v),
          ...
          (l[h.a] = b(o.a)
            ? t
              ...
              : l[h.p]
            : r.sv
              ? ((p.floor((r.sa * (2e3 / r.m) + r.sv) / r.sv) >> 1) + r.da) / 1e3
              : l[h.p] + r.da / 1e3),
          c.push(l);
      }
      ...
      for (
        ...
        if (
          ...
          for (;;) {
            ...
            if (
              ((o = 15 & a),
              0 == o ? (i.d = w([6])[0]) : 1 == o ? ((r.d = o = w([18])[0]), (i.d = 0)) : (i.d = o),
              !(16 & a))
            )
              break;
          }
    ...
    R = () => {
      var t, e, i, n;
      if (s > 1) return [];
      for (r.l = 0, n = -1, r.d = w([18])[0] - 1, i = w([18])[0]; r.d < i; )
        (e = S(1)),
          0 >= n
            ? (y() && (r.l += N()), (n = w([3 * r.l], [0])[0] + 1), t || ((t = [e]), n--))
            : t.push(e),
          n--;
      return t;
    },
    A = () => {
      var t, i, a, o;
      if (s >= 1) return [];
      for (r.f = w([6])[0], r.c = w([6])[0], a = [], r.dv = [], r.dl = [], t = 0; t < r.f; t++)
        (r.dv[t] = 0), (r.dl[t] = 0);
      for (t = 0; !(e >= n) && (e != n - 1 || 7 & (r.c ^ t)); t++) {
        for (o = [], i = 0; i < r.f; i++)
          y() && (r.dl[i] += N()), (r.dv[i] += w([3 * r.dl[i]], [1])[0]), (o[i] = r.dv[i]);
        a.push(o);
      }
      return a;
    },
    O = () => {
      ...
      for (t = []; ; ) {
              ...
              for (
                a.c++,
                  ...
                  y() &&
                    ...
                    y() && (r.wd = w([7])[0]),
                    a.s ^ r.b_sep &&
                      (a.s ? (r.u_p = r.u_c) : (r.u_o = r.u_h = r.u_l = r.u_c = r.u_p))),
                  u = 0;
                u < 3 + 2 * r.b_ph;
                u++
              )
                if (
                  ...
                  for (c = 0; 4 > c; c++)
                    (l = "ohlc".charAt(c)), (r["u_" + l] = P(r["u_" + l], o, r.p_p) - 0);
              !r.b_avp && a.a && (r.u_a = P((i && i.amount) || 0, 0, r.p_a));
            }
            if (y())
              for (a.c++, u = 0; u < 7 + r.b_ph + r.b_phx; u++)
            ...
            y()
              ? y()
                ? y()
                  ...
                  : (r.l_v += N())
                : r.b_ph && y()
                  ? (r["l_" + "et".charAt(r.b_phx && y())] += N())
                  : (r.l_a += N())
              : (r["l_" + "ohlc".charAt(w([2])[0])] += N());
        ...
        (i = {
          ...
          r.b_sep
            ? ((i.open = P((r.u_o += a.v_o), r.p_p)),
              (i.high = P((r.u_h += a.v_h), r.p_p)),
              (i.low = P((r.u_l += a.v_l), r.p_p)),
              (i.close = P((r.u_c += a.v_c), r.p_p)))
            : ((a.o = r.u_p + a.v_o),
              (i.open = P(a.o, r.p_p)),
          ...
          r.b_avp
            ? ((o = T(r.p_p)),
              ...
              (i.amount = P(
                P(
                  Math.floor(
                    (r.b_sep
                      ? (r.u_o + r.u_h + r.u_l + r.u_c) / 4
                      : a.o + (a.v_h - a.v_l + a.v_c) / 4) *
                      r.u_v +
                      0.5,
                  ),
                  [o[0] + l[0], o[1] + l[1]],
            ...
            : ((r.u_a += a.v_a), (i.amount = P(r.u_a, r.p_a))),
          r.b_ph &&
            ((i.postVol = P(a.v_e, r.p_e)),
            (i.postAmt = P(
              Math.floor(i.postVol * i.close + (r.b_phx ? P(a.v_t, r.p_t) : 0) + 0.5),
              0,
            ))),
          t.push(i);
      }
    ...
    E = (t) => {
      ...
      if (((t = (t || 0).toString()), (n = []), (i = t.toLowerCase().indexOf("e")), i > 0)) {
        for (e = t.substr(i + 1) - 0; e >= 0; e--) n.push(Math.floor(e * 10 ** -e + 0.5) - 0);
        return n.join("");
      }
      return t;
    };
